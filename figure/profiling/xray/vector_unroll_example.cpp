...
double duration_mus(const TP& from, const TP& to, unsigned rep)
{
...
int main(int argc, char** argv)  
{
    ...
    std::cout << "Compute time native loop is " << duration_mus(nat, nat_end, rep) << " micros.\n";
    std::cout << "u[0] is " << u[0] << '\n';
    ...
    std::cout << "Compute time unrolled loop is " << duration_mus(unr, unr_end, rep) << " micros.\n";
    std::cout << "u[0] is " << u[0] << '\n'; 
    ...
    std::cout << "Compute time unrolled loop is " << duration_mus(unr2, unr2_end, rep) << " micros.\n";
    std::cout << "u[0] is " << u[0] << '\n';
    ...
    std::cout << "Compute time unrolled loop is " << duration_mus(unr4, unr4_end, rep) << " micros.\n";
    std::cout << "u[0] is " << u[0] << '\n';
    ...
    std::cout << "Compute time unrolled loop is " << duration_mus(unr6, unr6_end, rep) << " micros.\n";
    std::cout << "u[0] is " << u[0] << '\n';
    ...
    std::cout << "Compute time unrolled loop is " << duration_mus(unr8, unr8_end, rep) << " micros.\n";
    std::cout << "u[0] is " << u[0] << '\n';
