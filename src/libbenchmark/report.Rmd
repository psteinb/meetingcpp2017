...
Looks like there is a tendency that integer based loops run faster on my laptop when accessing integer data! Interesting. Something worthwhile following up.
